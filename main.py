...
def login():
    ...
    query = "SELECT user_id, role_id, phone_number, email_address, password FROM user WHERE email_address=%s AND password = %s" 
    cursor.execute(query, (user_username, user_password)) 
...
def signup():                 
    ...
    get_phone_number = tk.Label(signup_page, text = "Phone Number: (+1)") #getting phone number
